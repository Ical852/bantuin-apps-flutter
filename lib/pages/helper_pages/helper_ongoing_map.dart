...
class HelperOnGoingMapPage extends StatefulWidget {
  @override
  State<HelperOnGoingMapPage> createState() => _HelperOnGoingMapPageState();

  UserModel customer;
  LatLng location;
  HelperOnGoingMapPage(this.customer, this.location);
}

class _HelperOnGoingMapPageState extends State<HelperOnGoingMapPage> {
